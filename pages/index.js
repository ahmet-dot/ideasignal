...
const STEPS = [
  ...
  "Scanning Reddit and Google signals...",
  "Reviewing competition and funding hints...",
  "Building the venture memo...",
    ...
    >
      ...
      {phase === "idle" && (
        ...
        >
          ...
          >
            startup viability · market signals · founder memo
          </p>
          ...
          >
            Structured startup analysis with external signals.
            <br />
            Market, competition, funding hints, and what to test next.
          </p>
          ...
          >
            // openai gpt-4.1-mini · reddit + google signals
          </p>
        </div>
      )}
              ...
              >
                ...
                <span
                  style={{
                    fontSize: 13,
                    color:
                      i <= stepIdx ? "rgba(255,255,255,0.7)" : "rgba(255,255,255,0.2)",
                  }}
                >
                  {s}
                </span>
      ...
      {phase === "error" && (
        ...
        >
          <p style={{ color: "#f87171", fontFamily: MONO, fontSize: 12, marginBottom: 10 }}>
            // error
          </p>
          <p
            style={{
...
function Report({ report, tab, setTab, onReset }) {
  ...
  return (
    <div style={{ maxWidth: 920, margin: "0 auto", padding: "48px 24px 0" }}>
        ...
        <div style={{ textAlign: "center" }}>
          <div
            style={{
              ...
              height: 88,
              borderRadius: "50%",
              border: `3px solid ${scoreColor10(report.overallScore)}`,
              display: "flex",
              flexDirection: "column",
              alignItems: "center",
              justifyContent: "center",
              background: `${scoreColor10(report.overallScore)}12`,
            }}
          >
            <span
              style={{
                fontSize: 30,
                fontWeight: 600,
                color: scoreColor10(report.overallScore),
                lineHeight: 1,
                fontFamily: SERIF,
              }}
            >
        ...
        {TABS.map((t) => (
          <button
            ...
            style={{
              ...
              border: "none",
              borderBottom:
                tab === t ? "2px solid rgba(255,255,255,0.7)" : "2px solid transparent",
                ...
                >
                  ...
                  <span
                    style={{
                      fontSize: 11,
                      fontWeight: 600,
                      color: assessmentColor(item.assessment),
                      fontFamily: MONO,
                      border: `1px solid ${assessmentColor(item.assessment)}33`,
                      padding: "3px 8px",
                      borderRadius: 999,
                    }}
                  >
          ...
          {(report.competitors || []).map((c, i) => (
            <div key={i} style={{ background: CARD, border: BORDER, borderRadius: 12, padding: 20 }}>
              <div style={{ marginBottom: 12 }}>
                <h3 style={{ fontFamily: SERIF, fontSize: 22, margin: "0 0 6px", fontWeight: 400 }}>
                  {c.name}
                </h3>
                <p style={{ fontSize: 13, color: "rgba(255,255,255,0.48)", margin: 0, lineHeight: 1.7 }}>
                  {c.summary}
                </p>
              </div>
      ...
      {tab === "signals" && (
        <div style={{ display: "grid", gap: 14 }}>
          <SignalCard title="Reddit Signals" items={report.marketSignals?.reddit || []} />
          <SignalCard title="Google Signals" items={report.marketSignals?.google || []} />
          <SignalCard title="Funding Hints" items={report.marketSignals?.fundingHints || []} />
        </div>
      )}
    </div>
  );
